...
- **Assets (3D Models & Textures)**: All `.glb` models, as well as the texture palettes, were created by and obtained from **Kenney.nl**. They are licensed under **CC0 1.0 Universal (Public Domain Dedication)**. We extend our thanks and credit to Kenney.nl for these fantastic assets!
